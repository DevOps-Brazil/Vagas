...
Repositório dedicado à divulgação de vagas para profissionais de DevOps, SRE, Cloud, Infraestrutura e áreas relacionadas.

## Sobre

Este repositório funciona como um quadro de vagas para a comunidade de DevOps. As vagas são publicadas como issues e automaticamente listadas neste README.

## Regras para publicação

1. As vagas devem ser publicadas como issues neste repositório
2. Informe no título a posição e localização (remoto, híbrido ou presencial)
